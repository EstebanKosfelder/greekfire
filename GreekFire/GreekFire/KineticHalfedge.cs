...
namespace GFL
{
    public class KineticHalfedge:Halfedge
    {
      
        public override string ToString() => $"K{base.ToString()} { Vertex.ID}-{Opposite?.Vertex?.ID}";
        ...
        {
          bool result =! (this.KNext.Opposite is KineticHalfedge);
        ...
        public WavefrontVertex KVertex {
            get{ Debug.Assert(Vertex is WavefrontVertex); return (WavefrontVertex)Vertex; }
            set { Vertex = value; } }
        public KineticHalfedge KPrev { 
            get { Debug.Assert(Prev is KineticHalfedge); return (KineticHalfedge) Prev; } 
            set { Prev = value; } 
        }

        public KineticHalfedge KNext
        {
            get { Debug.Assert(Next is KineticHalfedge); return (KineticHalfedge) Next; }
            set { Next = value; }
        }
