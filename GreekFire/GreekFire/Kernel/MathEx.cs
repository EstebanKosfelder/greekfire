namespace GFL.Kernel
{
    ...
    public static class MathEx
    {
        ...
        {
            return AreNear(a, 0.0, eps);
        }

        public static bool AreNear(this double a, double b, double eps = Const.EPSILON, bool greateOrEqual = true)
        {
            if (greateOrEqual)
                return Math.Abs(a - b) <= eps;
            else return Math.Abs(a - b) < eps;
        }
        ...
        public static (bool has_real_roots, bool is_square) solve_quadratic(Polynomial_1 f, out double x0, out double x1) => f.solve_quadratic(out x0, out x1);

        public static Polynomial_1 compute_determinant(Polynomial_1 x0, Polynomial_1 y0,
                          Polynomial_1 x1, Polynomial_1 y1,
                          Polynomial_1 x2, Polynomial_1 y2)
        {
            return (
              (x0 * y1
              + x1 * y2
