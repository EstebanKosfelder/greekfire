...
namespace GFL
{
    ...
    public class Halfedge:IHalfedge {
       ...
       public  Line2D wavefront_support_lines { get; set; }
        ...
        public Halfedge(int aID , SignEnum aSlope = SignEnum.ZERO)
        {
            ID = aID;
            Face = null;
            Vertex = null;
        ...
        public Vector2D Vector
        {
            get
            {
                ...
                Debug.Assert(Opposite.Vertex != null);
                Debug.Assert(Vertex != null);

                Vector2D s = Opposite.Vertex.Point;
                Vector2D t = Vertex.Point;
        ...
        public virtual bool IsBisector => !this.IsBorder;
