...
namespace GFL.Kernel
{
    ...
    public struct Polynomial_1
    {
        double[] a_ = new double[3];
        int degree_;
        public Polynomial_1(double a0 = 0.0, double a1 = 0.0, double a2 = 0.0)
        {
            a_ = new[] { a0, a1, a2 };
        ...
        public Polynomial_1 differentiate() => new Polynomial_1(a_[1], 2 * a_[2]);

       public  double evaluate(double at) => a_[2] * (at * at) + a_[1] * at + a_[0];

        public static Polynomial_1 operator *(Polynomial_1 m, Polynomial_1 o)
        {
            Debug.Assert(m.degree_ + o.degree_ <= 2);
            return new Polynomial_1(
                m.a_[0] * o.a_[0],
        ...
        public static Polynomial_1 operator +(Polynomial_1 m, Polynomial_1 o)
        {
            return new Polynomial_1(m.a_[0] + o.a_[0], m.a_[1] + o.a_[1], m.a_[2] + o.a_[2]);
        }
        public static Polynomial_1 operator -(Polynomial_1 m, Polynomial_1 o)
        {
            return new Polynomial_1(m.a_[0] - o.a_[0], m.a_[1] - o.a_[1], m.a_[2] - o.a_[2]);
